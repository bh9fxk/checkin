...
class UserInfo {
    ...
    async signin() {
		...
		headers: {
		    ...
		    'extra-data': '{"is_weapp":1,"sid":"YZ1294688889679880192YZCfA8sZ3F","version":"2.149.9.101","client":"weapp","bizEnv":"wsc","uuid":"EelabJsDgc5LycN1728719483867","ftime":1728719483865}'
		}
	    }
	    const req = https.request(options, res => {
		console.log(`\n状态码: ${res.statusCode}`)
